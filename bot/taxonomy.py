...
PESTS = [
    ...
    ("loxostege",         "Луговой мотылёк (бабочка)",        "Loxostege sticticalis",             False),
    ("loxostege_larva",   "Луговой мотылёк (гусеница)",       "Loxostege sticticalis",             False),
    ...
    ("helicoverpa",       "Совка хлопковая (бабочка)",        "Helicoverpa armigera",              False),

...
_BOT_GUIDE = (
    ...
    "• Узнать про поле: просто спроси словами — «что было на поле 119?», «история поля 119», "
    "«план по полю 119» — я отвечу по данным (обработки, культура, NDVI, погода, план). НЕ отсылай "
    "к командам вроде /field — если в блоке ДАННЫЕ ПО ПОЛЮ уже есть сводка, отвечай прямо по ней.\n"

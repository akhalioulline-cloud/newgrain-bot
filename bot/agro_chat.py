...
_REC_SYS = (
    ...
    "культуры») — они не различают. Если явного отличия нет — оставь только название, д.в. и норму. "
...
_SCAN_SYS = (
    ...
    "не различают препараты и не нужны. Если явного отличия нет — оставь только название, д.в. и норму, "
    ...
    "брендов. Плюс 1 агроприём. Если блока нет — назови д.в. и попроси уточнить культуру.\n"

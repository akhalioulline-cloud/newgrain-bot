...
_SYS = (
    ...
    "driver — механизатор/водитель как в заметке: фамилия С ИМЕНЕМ или инициалами, если "
    'они указаны (например "Шапаренко Сергей" или "Яровой В.Н."), иначе только фамилия; '
    "иначе null. Имя важно — есть однофамильцы.\n"

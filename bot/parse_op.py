...
_SYS = (
    ...
    'machine — основная техника (трактор/самоходка/КамАЗ) с номером, если указана '
    '(например "КамАЗ 286", "самоходка 6448", "6436"), иначе null\n'
    'implement — НАВЕСНОЕ/ПРИЦЕПНОЕ оборудование отдельно от трактора: косилка, грейдер, '
    'борона, культиватор, сеялка, опрыскиватель и т.п. с моделью/номером, если указано '
    '(например "СД-105", "КРН-2.1", "CATROS"), иначе null\n'
    "Пример логистики: «17 июня Двулучанский на камазе 286 подвозил воду» → "
    'driver="Двулучанский", machine="КамАЗ 286", operation="подвоз воды", implement=null, '
    "category=other, fields=[] (поля нет — машина возит на много полей сразу).\n"
    'Пример с оборудованием: «6437 Головочев СД-105 грейдирование дорог» → machine="6437", '
    'driver="Головочев", implement="СД-105", operation="грейдирование дорог", fields=[].\n'
